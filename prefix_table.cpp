...
// string prefix="78.45.33.12/32";
// string ip=to_binary(prefix);
// // cout<<"ip= "<<ip<<endl;
// tr.insert(ip,0,tr.root, result);
// cout<<"Added "+prefix+" "+ result+" "+ "at depth "<<ip.length()+1
// <<" , total nodes "<<tr.size << endl;


// result='A';
// prefix="78.45.33.11/32";
//  ip=to_binary(prefix);
// //  cout<<"ip= "<<ip<<endl;
// tr.insert(ip,0,tr.root, result);
// cout<<"Added "+prefix+" "+ result+" "+ "at depth "<<ip.length()+1
